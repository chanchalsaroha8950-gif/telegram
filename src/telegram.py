...
async def main():
    ...
    # Increase parallel upload connections, but keep reasonable for stability
    try:
        import math
        def _faster_conn_count(file_size: int, max_count: int = 16, full_size: int = 100 * 1024 * 1024) -> int:
    ...
    for video_file in video_files:
        ...
        try:
            ...
            while attempt < max_retries:
                ...
                try:
                    # Upload using parallel transfer with improved progress callback
